...
namespace Src.OLDPVE.MoveSearchers
{
    public class DuelAggressiveMoveSearcher : IBestMoveSearcher
    {
        ...
        public DuelAggressiveMoveSearcher(Board board, Vector2Int enemyCastlePosition, Vector2Int botCastlePosition,
            int botPlayerId, float defensiveDistance)
        {
            _board = board;
        ...
        {
            if (moves.Count == 0) throw new ArgumentException();
