...
namespace Src.OLDPVE.MoveSearchers.TraitsEvaluators
{
    public class EnemyStructureDeltaEvaluator : IMoveTraitEvaluator
    {
        ...
        public EnemyStructureDeltaEvaluator(IBoardCellsStateCalculator boardCellsStateCalculator,
            IUnitsStructureCalculator unitsStructureCalculator)
        {
        ...
        public float EvaluateTrait(AbstractMove move)
        {
            ...
            if (structureBeforeMove == 0) return 0;
