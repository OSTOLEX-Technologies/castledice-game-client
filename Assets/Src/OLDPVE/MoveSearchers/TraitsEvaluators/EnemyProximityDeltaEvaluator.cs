...
namespace Src.OLDPVE.MoveSearchers.TraitsEvaluators
{
    ...
    ///     Method EvaluateTrait returns the percentage of the change in the minimal distance from the friendly base to the
    ///     enemy.
    /// </summary>
    public class EnemyProximityDeltaEvaluator : IMoveTraitEvaluator
    {
        ...
        public float EvaluateTrait(AbstractMove move)
        {
            ...
            return (currentMinimalEnemyToBaseDistance - futureMinimalEnemyToBaseDistance) /
                   currentMinimalEnemyToBaseDistance;
        }
