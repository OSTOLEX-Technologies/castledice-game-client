...
namespace Src.PVE.MoveSearchers.TraitsEvaluators
{
    public class WeightedEnemyBaseProximityDeltaEvaluator : IMoveTraitEvaluator
    {
        ...
        public WeightedEnemyBaseProximityDeltaEvaluator(IGraphPathMinCostSearcher graphPathMinCostSearcher, IBoardCellsCostCalculator boardCellsCostCalculator, IBoardCellsStateCalculator boardCellsStateCalculator, Vector2Int enemyBasePosition)
        {
        ...
        private List<int> GetDistancesToUnits(List<Vector2Int> enemyPositions, int[,] costsBeforeMove)
        {
            ...
            {
                var distance = _graphPathMinCostSearcher.FindMinCost(costsBeforeMove, enemyPosition, _enemyBasePosition);
